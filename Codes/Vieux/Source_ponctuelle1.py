...
R = 0.1 *  3.085678e21#distance between the gamma-source and the IR source (cm)
...
L = np.sqrt(R**2 + Rs**2 - 2*R*Rs*np.cos(alpha)) #distance to the source (cm)
