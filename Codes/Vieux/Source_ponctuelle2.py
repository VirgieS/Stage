...
R = np.array([0.1, 2, 8.5, 10])*  3.085678e21#distance between the gamma-source and the IR source (cm)
Rs = 5 * 3.085678e21 #distance between us and the IR source (cm)
alpha = np.pi/2 #angle between the direction of the Sun-IR source and the direction gamma-source-IR souce (radian)

#Parameters
T = 20 #temperature of the CMB (K)
...
for k in range (len(R)):
    ...
    b = R[k] * Rs/L * np.sin(alpha) #impact parameter (cm)
